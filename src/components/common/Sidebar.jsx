import { BarChart2, Users, UserCheck, Calendar, Settings, Menu, Briefcase, CheckCircle } from "lucide-react"; 
...
const SIDEBAR_ITEMS = [
  ...
  { name: "Interview", icon: Briefcase, color: "#8B5CF6", href: "/interview" }, 
  { name: "Psychological Test", icon: CheckCircle, color: "#8B5CF6", href: "/test" }, 
  { name: "Test Scheduling", icon: CheckCircle, color: "#8B5CF6", href: "/scheduling" }, 
