...
const InterviewTable = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <Link to="/interview/create" className="text-green-400 hover:text-green-300 flex items-center">
          <Plus size={18} />
            ...
            {filteredInterviews.map((interview) => (
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300 flex gap-2">
                  <Link to={`/interview/edit/${interview.id}`} className="text-indigo-400 hover:text-indigo-300">
                    <Edit size={18} />
                  </Link>
                  <button
